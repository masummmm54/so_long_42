...
/*   Updated: 2024/01/13 13:12:13 by muhakose         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	player_image(t_game *game, int flag)
{
	if (flag == 1)
		...
		game->player->player_png_path = "assets/bombermandead1.png";
	else if (flag == 6)
		game->player->player_png_path = "assets/bombermandead2.png";
	else if (flag == 7)
		game->player->player_png_path = "assets/bombermandead3.png";
}
